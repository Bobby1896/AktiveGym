...
const NotificationEmail = () => {
  ...
  const { data: emailDetails, isLoading: isEmailLoading } =
    useGetNotificationEmailByIdQuery({ id: emailId }, { skip: !emailId });
  ...
  useEffect(() => {
    if (emailDetails) {
      setInitialValues({
        ...
        notificationName: emailDetails?.notificationType || "",
      });
    }
  }, [emailDetails]);
